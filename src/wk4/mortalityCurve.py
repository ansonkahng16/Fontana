...
def loadData(N,num_trials,sf,gamma_0):
	vitality_data = []
	gamma = str.replace(str(gamma_0),'.','d')

	csv_filename = '/Users/ansonkahng/Fontana/data/wk4/'+sf+'_'+str(N)+'_'+str(num_trials)+'_'+gamma+'.csv'
...
def mortalityCurve(N,num_trials,sf,vitality_cutoff,gamma_0,gamma_1,d):
	vitality_data = loadData(N,num_trials,sf,gamma_0)
	...
	# csv_filename = '/Users/ansonkahng/Fontana/data/wk4/'+sf+'_'+str(N)+'_'+str(num_trials)+'_data.csv'
	# csv_filename = '/Users/ansonkahng/Fontana/data/wk4/'+str(N)+'_'+str(num_trials)+'_data.csv'
	csv_filename = '/Users/ansonkahng/Fontana/data/wk4/testdata_highcutoff.csv'
...
def plotMortalityCurve(N,num_trials,sf,vitality_cutoff,gamma_0,gamma_1,d):
	...
	plt_filename = '/Users/ansonkahng/Fontana/data/wk4/'+sf+'_'+str(N)+'_'+str(num_trials)+'_mortality.png'
...
def plotMortalityRate(fpt, N,num_trials,sf,vitality_cutoff,gamma_0,gamma_1,d):
	...
	plt_filename = '/Users/ansonkahng/Fontana/data/wk4/'+sf+'_'+str(N)+'_'+str(num_trials)+'_mortalityrate.png'
	plt.savefig(plt_filename)
	# plt.show()
