...
# save graphs
os.system('python age.py 25000 0.0075 0.003 0 100 r 1 1 0 0.05')
print 'r saved'
os.system('python age.py 25000 0.0075 0.003 0 100 sf 1 1 0 0.05')
print 'sf saved'
...
os.system('python age.py 25000 0.00625 0.003 0 100 r 0 0 0 0.05')
print '1 done'
os.system('python age.py 25000 0.00625 0.006 0 100 r 0 0 0 0.05')
print '2 done'
os.system('python age.py 25000 0.00625 0.009 0 100 r 0 0 0 0.05')
print '3 done'
os.system('python age.py 25000 0.00625 0.003 0 100 sf 0 0 0 0.05')
print '4 done'
os.system('python age.py 25000 0.00625 0.006 0 100 sf 0 0 0 0.05')
print '5 done'
os.system('python age.py 25000 0.00625 0.009 0 100 sf 0 0 0 0.05')
print '6 done'
print 'gamma_1 done'
