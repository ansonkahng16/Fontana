...
def graphResults(vitality_data,N,num_trials,sf,gamma_0,gamma_1,d):
	...
	plt_filename = '/Users/ansonkahng/Fontana/data/wk5/'+sf+'_'+str(N)+'_'+str(num_trials)+'_'+gamma0+'_'+gamma1+'.png'
...
def saveGraph(graph,N,sf):
	graph_filename = '/Users/ansonkahng/Fontana/data/wk5/'+sf+'_'+str(N)+'.pkl'
