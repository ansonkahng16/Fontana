...
def plotMortalityCurve(N,num_trials,sf,vitality_cutoff,gamma_0,gamma_1,d):
	...
	plt_filename = '/Users/ansonkahng/Fontana/data/wk6/'+sf+'_'+str(N)+'_'+str(num_trials)+'_'+gamma0+'_'+gamma1+'_'+dstr+'_mortality.png'
...
def plotMortalityRate(fpt, N,num_trials,sf,vitality_cutoff,gamma_0,gamma_1,d):
	...
	plt_filename = '/Users/ansonkahng/Fontana/data/wk6/'+sf+'_'+str(N)+'_'+str(num_trials)+'_'+gamma0+'_'+gamma1+'_'+dstr+'_mortalityrate.png'
	plt.savefig(plt_filename)
	# plt.show()
