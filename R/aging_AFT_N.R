...
colors[conc=='r_2500_100_0.00625_0.0_0.0']="green";
colors[conc=='sf_2500_100_0.00625_0.0_0.0']="green";
colors[conc=='r_250_100_0.00625_0.0_0.0']="red";
colors[conc=='sf_250_100_0.00625_0.0_0.0']="red";
colors[conc=='r_25_100_0.00625_0.0_0.0']="blue";
colors[conc=='sf_25_100_0.00625_0.0_0.0']="blue";
...
colors = rep("black",length(conc));
colors[conc=='2500']="green";
colors[conc=='250']="blue";
colors[conc=='25']="red";
plot(s,col=colors,mark.time=F,xlab="time (days)",ylab="S[t]")
